...
import styles from './ArticleTipe1.module.css';
import React, { useState, useEffect } from 'react';

const ArticleTipe1 = ({ main, data, num, center }) => {
  ...
  return (
    data.results ? (
      <div className={styles.container}>
        ...
        <MiniArticle main={main} title={title} content={abstract} url={url} noTime={true} center={center ? center : ''} />
